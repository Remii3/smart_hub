...
function MainPage() {
  ...
  return (
    <>
      <div
        id='testScroll'
        className=' perspective-3 bg-pageBackground relative h-screen overflow-x-hidden scroll-smooth'
      >
        <Header />
        <section className='parallax__group relative min-h-screen w-screen'>
          <div className='sky absolute -top-20 left-0 right-0 bottom-0 flex items-center justify-center brightness-50'></div>
        </section>
