export default function TermsAndConditionPage() {
  return (
    <div>
      <div className="small-24 medium-16 large-19 columns medium-up-column-divider">
        ...
        <p>
          <span>
            This website is operated by <strong>Smarthub</strong>. The terms
            “we”, “us”, and “our” refer to <strong>Smarthub</strong>. The use of
            our website is subject to the following terms and conditions of use,
            ...
            in the pages of our website. Please review the Terms carefully. The
            Terms apply to all users of our website, including without
            ...
            you accept and agree to be bound by and comply with the Terms and
            our Privacy Policy. If you do not agree to the Terms or our Privacy
        ...
        <p>
          <span>
            <strong>Masovia </strong>and you irrevocably consent to the
        ...
        <p>
          <span>
            ...
            <strong>smarthub@gmail.com</strong>.
          </span>
        </p>
      </div>
    </div>
