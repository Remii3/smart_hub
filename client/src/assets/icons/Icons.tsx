...
export function CheckIcon({ height, width }: CheckiconTypes) {
  return (
...
export function TicketIcon({ height, width }: CheckiconTypes) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
      ...
      strokeWidth="1.5"
      stroke="currentColor"
      className={`-ms-1 me-1.5 h-${height} w-${width}`}
    >
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
...
export function TrashIcon({ height, width }: CheckiconTypes) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
...
export function CloseIcon({ height, width }: CheckiconTypes) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
...
export function CartIcon({ height, width }: CheckiconTypes) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
