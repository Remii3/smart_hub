...
function AuctionCard({ title, author, deadline, price }: PropsTypes) {
  return (
    <div>
      ...
      <div className="relative m-auto h-36 w-auto max-w-[300px] cursor-pointer rounded-lg bg-blue-400 shadow transition-[transform,box-shadow] duration-300 ease-out hover:scale-105 hover:shadow-lg active:scale-100">
